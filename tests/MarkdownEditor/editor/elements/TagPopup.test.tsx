...
import * as SuggestionModule from '../../../../src/MarkdownInputField/Suggestion';
...
describe('TagPopup Component', () => {
  ...
  const renderTagPopup = (props: any = {}) => {
    ...
    // 使用 React.createContext 来模拟 context
    const { Provider } = SuggestionModule.SuggestionConnext;
    ...
    return render(
      <ConfigProvider>
        ...
        >
          <Provider value={mockContext as any}>
      ...
      render(
        <ConfigProvider>
          <Slate
            ...
            initialValue={[{ type: 'paragraph', children: [{ text: 'test' }] }]}
          >
            <SuggestionModule.SuggestionConnext.Provider
              value={{
                open: false,
                setOpen,
                isRender: true,
