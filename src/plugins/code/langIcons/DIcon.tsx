...
interface DIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const DIcon: React.FC<DIconProps> = ({ size = '1em', ...props }) => {
  return (
    <svg
      width={size}
      height={size}
