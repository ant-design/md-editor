...
interface PrologIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const PrologIcon: React.FC<PrologIconProps> = ({
  size = 24,
  ...props
}) => {
  return (
