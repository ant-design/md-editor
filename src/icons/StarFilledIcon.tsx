...
/**
 * StarFilledIcon 组件 - 实心星星图标组件
 *
 * 该组件提供一个实心星星的SVG图标，通常用于表示收藏、评分等功能。
 * 图标采用五角星设计，填充样式表示已选中或激活状态。
 *
 * @component
 * @description 实心星星图标组件，用于表示收藏、评分等已选中状态
 ...
 * @example
 * ```tsx
 * <StarFilledIcon width="24px" height="24px" />
 * <StarFilledIcon className="custom-icon" style={{ color: 'gold' }} />
 * ```
 *
 * @returns {React.ReactElement} 渲染的实心星星图标组件
 *
 * @remarks
 * - 使用SVG格式，支持无损缩放
 * - 默认尺寸为1em，继承父元素字体大小
