...
interface MatlabIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const MatlabIcon: React.FC<MatlabIconProps> = ({
  size = 24,
  ...props
}) => {
  return (
    ...
    >
      <g fillRule="evenodd">
        <path
          d="M209.25 329.98 52.37 387.636l121.32 85.822 96.752-95.805-61.197-47.674z"
          fill="#4db6ac"
        />
        <path
