...
interface IniIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const IniIcon: React.FC<IniIconProps> = ({ size = '1em', ...props }) => {
  return (
    <svg
      width={size}
      height={size}
