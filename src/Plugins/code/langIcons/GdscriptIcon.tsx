...
interface GdscriptIconProps extends React.SVGProps<SVGSVGElement> {
  size?: number | string;
}

export const GdscriptIcon: React.FC<GdscriptIconProps> = ({
  size = 24,
  ...props
}) => {
  return (
    ...
    >
      ...
      />
      <path
        d="m11.8 16.764a1.819 1.819 0 1 1-1.819-1.819 1.817 1.817 0 0 1 1.819 1.819"
        fill="#414042"
      />
      <path
