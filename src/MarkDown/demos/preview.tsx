...
### 列表表单
<!-- {"MarkdownType": "section", "id": "18","submitText":"send" } -->
\`\`\`schema
        [
          {"title":"列表","valueType":"formList","dataIndex":"list","initialValue":[{"state":"all","title":"标题"}],"colProps":{"xs":24,"sm":12},"columns":[{"valueType":"group","columns":[{"title":"标题","dataIndex":"title","width":"md","formItemProps":{"rules":[{"required":true,"message":"此项为必填项"}]},"colProps":{"xs":24,"sm":12}}]}]}
        ]
\`\`\`
`;
export default () => {
