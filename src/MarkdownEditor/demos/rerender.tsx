...
const defaultValue = `| 指标大类 | 序号 | 核心指标 | 指标值 | 说明 | 责任人 | 投入比例（在其组织绩效占比） |
|----------|------|----------|--------|------|--------|--------------------------------|
| AI技术能力 | 1 | 打造全栈智能体产品技术服务体系，助力10+数科产品agent升级 | 信通院评级：4+<br>数科智能体升级：10 | 1. 构建行业领先具备差异化竞争力的2B智能体平台，通过信通院4+以上评级<br>2. AI评测能力平台化建设，同时制定AI产品的评测标准，具备指导性和权威性<br>3. 赋能10+数科产品的智能体升级 | 铭华 | 55% |
|          | 2 | 轻量化模型研发平台构建，具备大小模型训、推、管和一体化交付能力 | 1个平台：模型研发平台<br>轻量、快速交付：40+低代码组件，1周部署验证<br>标杆落地：3+场景应用 | 1. 平台能力：基于AntStack底座全面改造集团模型研发平台，具备大小模型训、推、管一体化能力，适配主流开源计算引擎和训练推理引擎<br>2. 轻量、快速交付：LUI快速生产能力（40+低代码组件）；1周完成部署和验证<br>3. AI产品矩阵多组合落地：结合Agent、AIPaaS多组合输出，落地三个以上标杆客户 | 若宾 | 55% |
|          | 3 | 构建商业版金融大模型全链路技术能力套件 | 标杆项目：10 | 1. 构建商业版金融大模型全链路技术能力套件，适配金融客户的大模型需求<br>2. 在公开权威金融评测集，超越开源金融模型，达到行业领先水平<br>3. 支持数科A+战役10+标杆达成，如宁波银行等金融行业标杆项目 | 铭华 | 20% |
