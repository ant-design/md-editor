...
import { Editor, Node, Path } from '@src/components/slate-packages/slate';
    ...
    <>
      <div
        ...
        style={{
          ...
          display:
            SEL_CELLS.get(editor) && SEL_CELLS.get(editor).length > 0
              ? 'none'
              : null,
        }}
      >
                ...
                if (curCell) {
                  ...
                  if (prevTrSlateNodePath) {
                    ...
                    RESIZING_ROW_ORIGIN_HEIGHT.set(
                      editor,
                      ReactEditor.toDOMNode(editor, trEntry[0])?.clientHeight ||
                        minHeight,
                    );
              ...
              if (thisDomRect) {
                ...
                if (curCell) {
                  ...
                  if (tdSlateNodePath) {
                    ...
                    if (!tablePath) return;
                    const tableNode: any =
                      Node.has(editor, tablePath) &&
                      Node.get(editor, tablePath);
              ...
              if (thisDomRect) {
                ...
                if (curCell) {
                  ...
                  if (trSlateNodePath) {
                    ...
                    RESIZING_ROW_ORIGIN_HEIGHT.set(
                      editor,
                      ReactEditor.toDOMNode(editor, entry[0])?.clientHeight ||
                        minHeight,
                    );
                    RESIZING_ROW_MIN_HEIGHT.set(editor, minHeight);
                  }
