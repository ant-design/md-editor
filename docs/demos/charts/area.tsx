...
import AreaChart, { AreaChartDataItem } from '../../../src/plugins/chart/AreaChart';
...
const DynamicAreaChartExample: React.FC = () => {
  ...
  const [data, setData] = useState<AreaChartDataItem[]>([
    ...
    // 营收数据类别
    { category: '营收数据', type: '本年营收', x: 1, y: 45000, xtitle: '月份', ytitle: '营收金额' },
    { category: '营收数据', type: '本年营收', x: 2, y: 52000, xtitle: '月份', ytitle: '营收金额' },
    { category: '营收数据', type: '本年营收', x: 3, y: 48000, xtitle: '月份', ytitle: '营收金额' },
    { category: '营收数据', type: '本年营收', x: 4, y: 61000, xtitle: '月份', ytitle: '营收金额' },
    { category: '营收数据', type: '本年营收', x: 5, y: 55000, xtitle: '月份', ytitle: '营收金额' },
    { category: '营收数据', type: '本年营收', x: 6, y: 67000, xtitle: '月份', ytitle: '营收金额' },

    { category: '营收数据', type: '去年营收', x: 1, y: 38000, xtitle: '月份', ytitle: '营收金额' },
    { category: '营收数据', type: '去年营收', x: 2, y: 41000, xtitle: '月份', ytitle: '营收金额' },
    { category: '营收数据', type: '去年营收', x: 3, y: 42000, xtitle: '月份', ytitle: '营收金额' },
    { category: '营收数据', type: '去年营收', x: 4, y: 48000, xtitle: '月份', ytitle: '营收金额' },
