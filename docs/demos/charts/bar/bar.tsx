...
const DynamicBarChartExample: React.FC = () => {
  ...
  const [data, setData] = useState<BarChartDataItem[]>([
    ...
    // 销售数据类别 - 全球
    { category: '销售数据', type: '本年销售额', x: 1, y: 85000, xtitle: '季度', ytitle: '销售额', filterLable: '全球' },
    { category: '销售数据', type: '本年销售额', x: 2, y: 92000, xtitle: '季度', ytitle: '销售额', filterLable: '全球' },
    { category: '销售数据', type: '本年销售额', x: 3, y: 88000, xtitle: '季度', ytitle: '销售额', filterLable: '全球' },
    { category: '销售数据', type: '本年销售额', x: 4, y: 105000, xtitle: '季度', ytitle: '销售额', filterLable: '全球' },

    { category: '销售数据', type: '去年销售额', x: 1, y: 72000, xtitle: '季度', ytitle: '销售额', filterLable: '全球' },
    { category: '销售数据', type: '去年销售额', x: 2, y: 78000, xtitle: '季度', ytitle: '销售额', filterLable: '全球' },
    { category: '销售数据', type: '去年销售额', x: 3, y: 81000, xtitle: '季度', ytitle: '销售额', filterLable: '全球' },
    { category: '销售数据', type: '去年销售额', x: 4, y: 89000, xtitle: '季度', ytitle: '销售额', filterLable: '全球' },
    ...
    { category: '销售数据', type: '本年销售额', x: 1, y: 95000, xtitle: '季度', ytitle: '销售额', filterLable: '美国' },
    { category: '销售数据', type: '本年销售额', x: 2, y: 102000, xtitle: '季度', ytitle: '销售额', filterLable: '美国' },
    { category: '销售数据', type: '本年销售额', x: 3, y: 98000, xtitle: '季度', ytitle: '销售额', filterLable: '美国' },
    { category: '销售数据', type: '本年销售额', x: 4, y: 115000, xtitle: '季度', ytitle: '销售额', filterLable: '美国' },

    { category: '销售数据', type: '去年销售额', x: 1, y: 82000, xtitle: '季度', ytitle: '销售额', filterLable: '美国' },
    { category: '销售数据', type: '去年销售额', x: 2, y: 88000, xtitle: '季度', ytitle: '销售额', filterLable: '美国' },
    { category: '销售数据', type: '去年销售额', x: 3, y: 91000, xtitle: '季度', ytitle: '销售额', filterLable: '美国' },
    { category: '销售数据', type: '去年销售额', x: 4, y: 99000, xtitle: '季度', ytitle: '销售额', filterLable: '美国' },
  ]);

  const handleRandomize = () => {
    setData(prev => prev.map(item => ({
      ...item,
      y: item.category === '销售数据'
